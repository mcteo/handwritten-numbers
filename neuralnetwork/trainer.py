...
class Trainer(object):
    ...
    def __init__(self, num_hidden, training_file):
        self.num_hidden = num_hidden
        self.testcases = self.parse_input(training_file)
        
        # trains on 100% of data, unless overridden by subclass
        self.testcase_ratio = 1.0
    ...
    def train(self, learning_rate, max_timesteps=None, error_threshold=None):
        ...
        while True:
            ...
            print "Error at timestep", timesteps, "=", timestep_error
